...
const Header = () => {
  return (
    <div className="relative">
      <header className="fixed top-0 left-0 right-0 z-10 mx-10 bg-amber-300">
        <div className="bg-white max-w-330 mx-auto flex justify-between items-center py-5 px-7 mt-5 rounded-2xl">
